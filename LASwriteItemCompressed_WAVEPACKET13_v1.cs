...
namespace LASzip.Net
{
	class LASwriteItemCompressed_WAVEPACKET13_v1 : LASwriteItemCompressed
	{
		...
		public unsafe override bool init(laszip.point item, ref uint context)
		{
			// init state
			last_diff_32 = 0;
		...
		public unsafe override bool write(laszip.point item, ref uint context)
		{
			...
			fixed (byte* pItem = item.wave_packet)
			{
				...
				if (curr_diff_64 == (long)(curr_diff_32))
				{
					...
					else if (curr_diff_32 == (int)last_item.packet_size)
					{
